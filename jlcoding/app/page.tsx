...
import { Sparkles, Loader2, Check, Paperclip, X, FileCode2, Plug, PanelLeftClose } from 'lucide-react'
      ...
      <>
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/70 p-4 shadow-2xl transition-all focus-within:border-indigo-500 focus-within:shadow-[0_0_32px_rgba(99,102,241,.25)]">
            ...
            <textarea
              ...
              rows={4}
              placeholder={agentId === 'data-analyst' ? '描述你的数据问题，并点击右下角 📎 上传文件…' : '描述你想做的应用，越具体越好…'}
              ...
              <div className="ml-auto flex items-center gap-1.5">
                ...
                <div className="group relative">
                  <button className="flex h-8 items-center gap-1.5 rounded-full border border-zinc-700 bg-zinc-900 px-3 text-xs text-zinc-200 hover:border-zinc-500">
                    <span className="h-1.5 w-1.5 rounded-full bg-emerald-500" />{currentModel.label}
                  </button>
          ...
          <button
            ...
            className="mt-3 flex items-center justify-center gap-2 rounded-xl border border-dashed border-zinc-800 py-2.5 text-xs text-zinc-500 transition-colors hover:border-indigo-700 hover:text-zinc-300"
          >
